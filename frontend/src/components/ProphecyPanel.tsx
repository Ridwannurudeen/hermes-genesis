  ...
  return (
    <div className="absolute top-4 right-4 z-20">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-white/[0.04] backdrop-blur-xl border border-gilt-500/30 rounded-lg text-gilt-500 hover:text-gilt-400 hover:bg-hover transition-all"
      >
      ...
      <AnimatePresence>
        {expanded && (
          <motion.div
            ...
            className="mt-2 w-72 sm:w-80 bg-page/90 backdrop-blur-xl border border-gilt-500/20 rounded-xl overflow-hidden shadow-xl shadow-ink-900/10"
          >
            <div className="p-3 border-b border-subtle">
              <h3 className="text-sm font-semibold text-gilt-500 flex items-center gap-2">
