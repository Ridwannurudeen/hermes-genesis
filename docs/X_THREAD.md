...
Two more Hermes critics score it for slop and factual consistency.
...
"Seraphina's Final Entry" — 1,212 words, diary voice.

Anti-slop: 0.92
Fact-check: 0.88

Critic-passed. ElevenLabs narrated. FLUX illustrated.

The civilization keeps publishing after I close the tab.
...
/k/ palatalizes between vowels in the Cinder period.

karim (moon · Lunar era)
   → cherim (Cinder)
      → cherim-en (Ash)

Each entry has a sample lexicon, sample text, inscriptions, sound shifts.
...
· /chronicle — read the canon
· /watch — full-screen cinematic playback of historical events
· /glossary — the constructed-language family tree
· /regen — seed your own civilization from one sentence
...
I built Hermes Genesis as an entry to the Nous Research Hermes Agent
hackathon. It's an autonomous-fiction engine: one sentence in, a
self-writing canon out. Three AI agents publish a fictional Wikipedia
article-by-article, indefinitely.

The gap I was filling: Stanford's Generative Agents (Smallville)
simulated NPCs walking around a town, but it doesn't publish anything.
AI Dungeon writes choose-your-own-adventure. Hidden Door does
multi-player IP-licensed narrative. Nobody built a system that
produces a coherent encyclopedia about a fictional civilization —
articles that cross-reference each other, characters who persist,
language that drifts across centuries.

Pipeline: every simulated event runs through Hermes-4-70B, which decides
if it's article-worthy and picks the kind/voice/length. Kimi-K2.6 writes
the long-form prose (typically 1,000–1,500 words) in the voice of the
...
Source: https://github.com/Ridwannurudeen/hermes-genesis

If you've worked on generative-agent systems, narrative AI,
worldbuilding tools, or conlangs, I'd love feedback. Especially on the
linguistic-drift module — I want to know if it holds up to a
