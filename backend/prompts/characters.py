...
- One leader per faction, rest are diverse roles
- Genome values 0.0-1.0 reflecting personality
- 1-2 relationships per character
- Characters in regions their faction controls
- Diverse ages (18-70)"""
